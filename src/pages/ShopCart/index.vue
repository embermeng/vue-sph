    ...
    <div class="cart">
            ...
            <div class="cart-body">
                ...
                >
                    ...
                    <li class="cart-list-con4">
                        <span class="price">{{ cart.skuPrice || 1000 }}</span>
                    </li>
                    ...
                    <li class="cart-list-con6">
                        <span class="sum">{{
                            cart.skuNum * (cart.skuPrice || 1000)
                        }}</span>
                    </li>
        ...
        <div class="cart-tool">
            ...
            <div class="money-box">
                ...
                <div class="sumbtn">
                    <router-link class="sum-btn" style="cursor: pointer" to="/trade">结算</router-link>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        async delCartById(cart) {
            try {
                // 如果删除成功，再次发请求
                await this.$store.dispatch("delCartListBySkuId", cart.skuId);
                this.getData();
            } catch (error) {
                alert(error.message);
            }
